    ...
    >
      <template v-slot:body>
        <div class="edit-wrap">
          ...
          <div class="item">
            <div class="city">省市区</div>
            <select name="province" v-model="checkedItem.receiverProvince">
              <option v-for="(province,index) of provinces" :key="index" :value="province">{{ province.name }}</option>
            </select>
            <select name="city" v-model="checkedItem.receiverCity">
              <option v-for="(city, index) of checkedItem.receiverProvince && checkedItem.receiverProvince.child" :key="index" :value="city">{{ city.name }}</option>
            </select>
            <select name="district" v-model="checkedItem.receiverDistrict">
             <option v-for="(area,index) of checkedItem.receiverCity && checkedItem.receiverCity.child" :key="index" :value="area">{{ area.name }}</option>
            </select>
          </div>
          <div class="item">
...
export default {
  ...
  computed: {
    provinces() {
      return city.china_city_area_zip
    },
  },
